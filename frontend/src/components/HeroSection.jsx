  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        {/* Headline */}
        <h1 className="text-3xl pt-4 sm:text-4xl md:text-5xl font-bold text-power-500 drop-shadow-lg animate-fade-in">
        ...
        <div className="flex flex-col pt-4 sm:flex-row gap-4 justify-center items-center mt-10 animate-slide-up">
          <div className="flex items-center space-x-2 bg-power-500 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-energy-100">
          ...
          <div className="flex items-center space-x-2 bg-power-500 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-power-100">
            <div className="w-3 h-3 bg-energy-500 rounded-full animate-pulse"></div>
            <span className="text-energy-500 font-medium">Real-time Updates</span>
          </div>
          <div className="flex items-center space-x-2 bg-power-500 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-electric-100">
            <div className="w-3 h-3 bg-energy-500 rounded-full animate-pulse"></div>
